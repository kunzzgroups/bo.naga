...
(function (global) {
  ...
  const SLOTS = [
    ...
    },
    {
      id: 'mobileLogin',
      zone: 'website-top',
      label: 'Mobile Login Button / Image',
      shared: true,
      hint: 'Used on mobile only. If empty, the desktop Login image is used automatically.',
      all: { field: 'mobileLoginUrl', fileKey: 'mobileLogin', label: 'mobile login', apiKeys: ['mobileLoginUrl', 'mobileLogin'] },
    },
    {
      id: 'mobileRegister',
      zone: 'website-top',
      label: 'Mobile Register Button / Image',
      shared: true,
      hint: 'Used on mobile only. If empty, the desktop Register image is used automatically.',
      all: { field: 'mobileRegisterUrl', fileKey: 'mobileRegister', label: 'mobile register', apiKeys: ['mobileRegisterUrl', 'mobileRegister'] },
    },
    {
      id: 'referral',
      zone: 'left',
    ...
    },
    {
      id: 'mobileDeposit',
      zone: 'right',
      label: 'Mobile Deposit Button / Image',
      shared: true,
      hint: 'Used on mobile only. If empty, the desktop Deposit image is used automatically.',
      all: { field: 'mobileDepositUrl', fileKey: 'mobileDeposit', label: 'mobile deposit', apiKeys: ['mobileDepositUrl', 'mobileDeposit'] },
    },
    {
      id: 'mobileWithdraw',
      zone: 'right',
      label: 'Mobile Withdraw Button / Image',
      shared: true,
      hint: 'Used on mobile only. If empty, the desktop Withdraw image is used automatically.',
      all: { field: 'mobileWithdrawUrl', fileKey: 'mobileWithdraw', label: 'mobile withdraw', apiKeys: ['mobileWithdrawUrl', 'mobileWithdraw'] },
    },
    {
      id: 'refresh',
      zone: 'right',
