const API_CONFIG = window.API_CONFIG || {
    ...
    ENDPOINTS: {
        ...
        PAYMENT_GATEWAY_SAVE: "/admin/payment-gateway/gateway/save",
        PAYMENT_GATEWAY_ENDPOINT_SAVE: "/admin/payment-gateway/endpoint/save",
        PAYMENT_GATEWAY_CHANNEL_SAVE: "/admin/payment-gateway/channel/save",
        PAYMENT_GATEWAY_DELETE: "/admin/payment-gateway/gateway/delete",
        PAYMENT_GATEWAY_CHANNEL_DELETE: "/admin/payment-gateway/channel/delete",
        PAYMENT_GATEWAY_TRANSACTIONS: "/admin/payment-gateway/transactions",
        PAYMENT_GATEWAY_STATUS_CHECK: "/admin/payment-gateway/transaction",
