...
(function () {
    ...
    const assets = [
        ...
        { field: 'logoUrlZh', fileKey: 'logoZh', label: 'Chinese logo', fallback: assetUrl('logo_zh.png'), apiKeys: ['logoZh', 'logo_zh'] },
        { field: 'faviconUrl', fileKey: 'favicon', label: 'favicon', fallback: assetUrl('favicon.png') },
        { field: 'faviconUrlZh', fileKey: 'faviconZh', label: 'Chinese favicon 16x16', fallback: assetUrl('favicon_zh.png'), apiKeys: ['faviconZh', 'favicon_zh'] },
        { field: 'faviconUrl2', fileKey: 'favicon2', label: 'favicon 32x32', fallback: assetUrl('favicon2.png') },
        { field: 'faviconUrl2Zh', fileKey: 'favicon2Zh', label: 'Chinese favicon 32x32', fallback: assetUrl('favicon2_zh.png'), apiKeys: ['favicon2Zh', 'favicon2_zh'] },
        { field: 'faviconUrl3', fileKey: 'favicon3', label: 'favicon 180x180', fallback: assetUrl('favicon3.png') },
        { field: 'faviconUrl3Zh', fileKey: 'favicon3Zh', label: 'Chinese favicon 180x180', fallback: assetUrl('favicon3_zh.png'), apiKeys: ['favicon3Zh', 'favicon3_zh'] },
        ...
        { field: 'pageBackgroundUrlZh', fileKey: 'backgroundZh', label: 'Chinese background', fallback: assetUrl('background_zh.png'), apiKeys: ['backgroundZh', 'pageBackgroundZh', 'background_zh'] },
        { field: 'referralUrl', fileKey: 'referral', label: 'referral', fallback: assetUrl('referral.png') },
        { field: 'referralUrlZh', fileKey: 'referralZh', label: 'Chinese referral', fallback: assetUrl('referral_zh.png'), apiKeys: ['referralZh', 'referral_zh'] },
        { field: 'shareUrl', fileKey: 'share', label: 'share', fallback: assetUrl('share.png') },
        { field: 'shareUrlZh', fileKey: 'shareZh', label: 'Chinese share', fallback: assetUrl('share_zh.png'), apiKeys: ['shareZh', 'share_zh'] },
        { field: 'downlineUrl', fileKey: 'downline', label: 'downline', fallback: assetUrl('downline.png') },
        { field: 'downlineUrlZh', fileKey: 'downlineZh', label: 'Chinese downline', fallback: assetUrl('downline_zh.png'), apiKeys: ['downlineZh', 'downline_zh'] },
        { field: 'copylinkUrl', fileKey: 'copylink', label: 'copy link', fallback: assetUrl('copylink.png') },
        { field: 'copylinkUrlZh', fileKey: 'copylinkZh', label: 'Chinese copy link', fallback: assetUrl('copylink_zh.png'), apiKeys: ['copylinkZh', 'copylink_zh'] },
        { field: 'facebookUrl', fileKey: 'facebook', label: 'Facebook', fallback: assetUrl('facebook.png') },
        { field: 'facebookUrlZh', fileKey: 'facebookZh', label: 'Chinese Facebook', fallback: assetUrl('facebook_zh.png'), apiKeys: ['facebookZh', 'facebook_zh'] },
        { field: 'telegramUrl', fileKey: 'telegram', label: 'Telegram', fallback: assetUrl('telegram.png') },
        { field: 'telegramUrlZh', fileKey: 'telegramZh', label: 'Chinese Telegram', fallback: assetUrl('telegram_zh.png'), apiKeys: ['telegramZh', 'telegram_zh'] },
        { field: 'loginUrl', fileKey: 'login', label: 'login', fallback: assetUrl('login.gif') },
        { field: 'loginUrlZh', fileKey: 'loginZh', label: 'Chinese login', fallback: assetUrl('login_zh.gif'), apiKeys: ['loginZh', 'login_zh'] },
        { field: 'registerUrl', fileKey: 'register', label: 'register', fallback: assetUrl('register.gif') },
        { field: 'registerUrlZh', fileKey: 'registerZh', label: 'Chinese register', fallback: assetUrl('register_zh.gif'), apiKeys: ['registerZh', 'register_zh'] },
        { field: 'depositUrl', fileKey: 'deposit', label: 'deposit', fallback: assetUrl('deposit.png') },
        { field: 'depositUrlZh', fileKey: 'depositZh', label: 'Chinese deposit', fallback: assetUrl('deposit_zh.png'), apiKeys: ['depositZh', 'deposit_zh'] },
        { field: 'withdrawUrl', fileKey: 'withdraw', label: 'withdraw', fallback: assetUrl('withdraw.png') },
        { field: 'withdrawUrlZh', fileKey: 'withdrawZh', label: 'Chinese withdraw', fallback: assetUrl('withdraw_zh.png'), apiKeys: ['withdrawZh', 'withdraw_zh'] },
        { field: 'refreshUrl', fileKey: 'refresh', label: 'refresh', fallback: assetUrl('refresh.png') },
        { field: 'refreshUrlZh', fileKey: 'refreshZh', label: 'Chinese refresh', fallback: assetUrl('refresh_zh.png'), apiKeys: ['refreshZh', 'refresh_zh'] },
        { field: 'homeUrl', fileKey: 'home', label: 'home', fallback: assetUrl('home.png') },
        { field: 'homeUrlZh', fileKey: 'homeZh', label: 'Chinese home', fallback: assetUrl('home_zh.png'), apiKeys: ['homeZh', 'home_zh'] },
        { field: 'historyUrl', fileKey: 'history', label: 'history', fallback: assetUrl('history.png') },
        { field: 'historyUrlZh', fileKey: 'historyZh', label: 'Chinese history', fallback: assetUrl('history_zh.png'), apiKeys: ['historyZh', 'history_zh'] },
        { field: 'bonusUrl', fileKey: 'bonus', label: 'bonus', fallback: assetUrl('bonus.png') },
        { field: 'bonusUrlZh', fileKey: 'bonusZh', label: 'Chinese bonus', fallback: assetUrl('bonus_zh.png'), apiKeys: ['bonusZh', 'bonus_zh'] },
        { field: 'livechatUrl', fileKey: 'livechat', label: 'live chat', fallback: assetUrl('livechat.png') },
        { field: 'livechatUrlZh', fileKey: 'livechatZh', label: 'Chinese live chat', fallback: assetUrl('livechat_zh.png'), apiKeys: ['livechatZh', 'livechat_zh'] },
        { field: 'settingUrl', fileKey: 'setting', label: 'setting', fallback: assetUrl('setting.png') },
        { field: 'settingUrlZh', fileKey: 'settingZh', label: 'Chinese setting', fallback: assetUrl('setting_zh.png'), apiKeys: ['settingZh', 'setting_zh'] },
    ];
