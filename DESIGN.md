...
- Dark: surfaces `#383A46` / wells `#2A2C36` / borders `rgba(255,255,255,.10–.14)` / L2 chip amber-on-charcoal. Panel scrollbars follow the chocolate/amber pill (`#8B6B4A` / `#F59E0B`, `6px`, no arrows).
